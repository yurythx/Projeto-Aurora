...
const description =
  "Política de Privacidade e Proteção de Dados Pessoais do Projeto Aurora, em conformidade com a LGPD (Lei 13.709/2018).";

export const metadata: Metadata = {
  title: "Política de Privacidade — Projeto Aurora",
  description,
  openGraph: { title: "Política de Privacidade — Projeto Aurora", description, type: "website" },
};
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-10 px-6 py-12">
        <section className="flex flex-col gap-4">
          ...
          <p className="text-muted leading-relaxed">
            Esta política descreve como o <strong>Projeto Aurora</strong>, infraestrutura da{" "}
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-sm text-muted leading-relaxed">
            O controlador dos dados é a <strong>Prefeitura Municipal de Rondonópolis/MT</strong>. O
            Projeto Aurora é a base tecnológica sobre a qual os sistemas municipais são construídos; cada
            sistema derivado pode ter finalidades específicas descritas em seu próprio aviso de
            privacidade.
          </p>
        </section>
